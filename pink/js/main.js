window.onload = function() {
  ...
  if(document.querySelector('.card-blog-left .nav-page')){
    if (w < 1080){
      let title = document.querySelector('.card-blog-left .nav-page'); 
      let top = document.querySelector('.card-blog-left-title'); 
      document.querySelector('.new-title').appendChild(title).appendChild(top)
    }
  }

  if(document.querySelector('.swiper-about-slide-left p img')){
    if (w > 700) {
      let aboutimgstart = document.querySelectorAll('.swiper-about-slide-left p img');
      for(let i = 0; i<aboutimgstart.length; i++){
         document.querySelector('.swiper-about-slide-img').appendChild(aboutimgstart[i])
      }
    }
  }
