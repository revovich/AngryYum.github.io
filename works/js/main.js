...
var img = document.querySelectorAll('.news_wrap_slider img');
var btn_prev = document.querySelector('.news_slider_prev');
var i = 0;
btn_prev.onclick = function () {
  ...
  img[i].className = 'news_wrap_slider_img_active';
}
document.querySelector('.news_slider_next').onclick = function () {
  img[i].className = '';
  i++
  if (i >= img.length) {
    i = 0;
